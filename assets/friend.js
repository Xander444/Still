...
(function (root, factory) {
  ...
  function reply(memory, raw, t, { turn, topic, frame, name, learned, emotional, facts } = {}) {
    ...
    if (/\b(?:i am|i feel) (?:worthless|a failure|unlovable|useless|a loser|stupid|broken|a terrible person|not good enough)|\beveryone hates me\b/.test(t)) return { text: 'That sounds painful. I won’t treat that harsh thought as a fact about you. What happened that brought it up?', rule: 'friend-self-criticism', suggestions: [] };
